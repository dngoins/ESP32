...
void loop() {
  ...
  */
  ...
  if ((lightVal > (baseLightVal))) {
    digitalWrite(lightLed, HIGH);
  } else if ((lightVal < (baseLightVal))) {
    digitalWrite(lightLed, LOW);
  }
  ...
  */
  ...
  if (toggleTouch) { digitalWrite(touchLed, HIGH); }  // if touched
  else {
    digitalWrite(touchLed, LOW);
  }
  ...
  */
  ...
  // Take the currentSoundState value and save it as an audio file
  ...
  Serial.print("Current Sound State:\t");
  Serial.println(currentSoundState);
